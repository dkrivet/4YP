function [optimal_cost, optimal_control_input, alpha_k_current, alpha_k_1, predicted_v, sol] = compute_optimal_solution_V_form(current_time_step, A0, A1, A2, A3, B0, B1, B2, B3, N, F, G, V, PI_w, pi_w, vertices, K, R, Q, x_k, number_of_vertices, U_j, PI_theta, pi_theta, theta_hat, M0, previous_control_input, previous_v)
...
if current_time_step > 1
    ...
    for i = 1:(N-1)
        ...
        x(:,i+1) = A_theta_hat * x_hat(:,i) + B_theta_hat * u_hat(i);
    end
