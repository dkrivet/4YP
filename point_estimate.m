function current_point_estimate = point_estimate(A0, A1, A2, A3, B0, B1, B2, B3, x_k, x_k_1, u_k, u_k_1, previous_point_estimate, PI_theta, pi_theta)
...
% arbitrarily set mu at the moment because I dont know how to calculate it
mu = 1;
